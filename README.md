...
1. Few higlights:
    i. I used Joi validator to validate all entries comming to both endpoints.
    ii. I wrote the tests with jest and supertest.
    iii. I used 'bull' as a queuing service that handles the limit of trnsactions per/minute (constants file)
...
3. How to run it.
    i. run 'yarn' on your terminal followed by 'docker-compose up' (then cd into root and run 'yarn start')
